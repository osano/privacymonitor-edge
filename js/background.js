(function () {
    ...
    const urls = {
        ...
        onInstalledURL: 'https://www.privacymonitor.com/welcome/edge/',
        onUninstallURL: 'https://www.privacymonitor.com/goodbye/edge/'
    };
    ...
    browser.runtime.setUninstallURL(urls.onUninstallURL);
    ...
    browser.runtime.onInstalled.addListener(function (object) {
        if(object.reason === 'install'){
            browser.tabs.create({url: urls.onInstalledURL}, function (tab) {
                return;
            });
        }
    });
    ...
    function sendDataToContentScriptActive(tabId, domain, data){
        browser.browserAction.setIcon({
				path : "css/images/iconColored.png",
				tabId : tabId
		});
